...
<body>
<form name="myForm" onsubmit="return validateForm()" action="Controller"method="post">
<div class="container">
<div align="left">UserName:<input type="text" name="username"/></div><br/><br/>
<div align="left">PassWord:<input type="password"name="password"/></div><br/><br/>
<div align="left">E-mail:<input type="email"name="email"/></div><br/><br/>
...
<div align="left"><input type ="Submit"value="Create"/></div></div>
</form>
</body>
</html>